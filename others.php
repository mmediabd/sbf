...
<div class="page-header">
		...
		<h4 class="text-center"><u>PTC Other's Cost Input</u></h4>
	</div><!-- /.page-header -->
			    ...
			    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			        ...
			        $userid 		= mysqli_real_escape_string($db->link, $_POST['userid']);
			         ...
			         if ($amount == "" || $entry_date == "" || $vauchar == "" || $purpose == "" ||  $client == "") {
			         	...
			         	$cquery = "SELECT * FROM tbl_otherscost WHERE vauchar = '$vauchar'";
			            ...
			            $query = "INSERT INTO tbl_otherscost(amount, entry_date, vauchar, purpose, client, remark, username) VALUES('$amount', '$entry_date', '$vauchar', '$purpose', '$client', '$remark', '$username')";
...
<form class="form-horizontal text-center" role="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-xs-8 col-sm-7">
				<input type="text" placeholder="Enter your Coment" class="col-xs-10 col-sm-5" name="remark" />
			</div>
		</div>
...
<tbody>
<?php
$query ="SELECT * FROM tbl_otherscost order by id desc";
	...
	<tr>
		...
		<td>
			<div class="">
				...
				<!-- Preview option -->
				<?php
					$selected="SELECT * FROM tbl_otherscost order by id";
				...
				<div class="modal-body">
				    ...
				    <p><h5><b>Vouchar No : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $vauchar; ?>">

				    <p><h5><b>Purpose of Cost : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $purpose; ?>">

				    <p><h5><b>Client Name : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $client; ?>">
				...
				||
				<!-- Edit option -->
				<a href="editothers.php?editId=<?php echo $result['id'];?>">
					<span class="glyphicon glyphicon-edit"></span>
				</a>
				<!-- Edit option -->
				||
				<a onclick="return confirm('Are you sure to Delete!');" class="red" href="deleteOtherscost.php?delid=<?php echo $result['id'];?>">
