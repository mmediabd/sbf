...
<div class="page-header">
		...
		<h4 class="text-center"><u>SBF To Sister Concern</u></h4>
	</div><!-- /.page-header -->
	...
	<div class="row">
			...
			<?php
			    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			        ...
			        $userid 		= mysqli_real_escape_string($db->link, $_POST['userid']);
			         ...
			         if ($concern == "" || $inputdate == "" || $give_amount == "") {
			         	...
			         	/* block vauchar nomber..........
			         	$cquery = "SELECT * FROM tbl_sbfToSisterconcern WHERE vouchar = '$vouchar'";
				        ...
				        if ($check) {
				        	...
				        	*/
			            $query = "INSERT INTO tbl_sbftosisterconcern(concern, inputdate, give_amount, vouchar, remark, username) VALUES('$concern', '$inputdate', '$give_amount', '$vouchar', '$remark', '$username')";
		...
		<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="form-horizontal text-center" role="form">
				...
				<div class="form-group">
					<label class="col-xs-4 col-sm-5 control-label"> Give Amount :</label>
					<div class="col-xs-8 col-sm-7">
						<input type="text" placeholder="Enter Give Amount......" class="col-xs-10 col-sm-5" name="give_amount"/>
					</div>
				</div>
...
<div>
	<table id="dynamic-table" class="table table-striped table-bordered table-hover">
		...
		<tbody>
	<?php
		$query ="SELECT * FROM tbl_sbftosisterconcern order by id desc limit 100";
		...
		if ($installment) {
			...
			<tr>
				...
				<td><?php echo "Tk. ".$result['give_amount'];?></td>
				...
				<td>
					<div class="">
						...
						<!-- Preview option -->
						<?php
							$selected="SELECT * FROM tbl_sbftosisterconcern order by id";
						...
						<div class="modal-body">
						    ...
						    <p><h5><b>Give Amount : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $give_amount; ?>">
						...
						||
						<!-- Edit option -->
						<a href="editsbftosisterconcern.php?editId=<?php echo $result['id'];?>">
							<span class="glyphicon glyphicon-edit"></span>
						</a>
						<!-- Edit option -->
						||
						<a onclick="return confirm('Are you sure to Delete!');" class="red" href="deletesbftoSisternconcern.php?delid=<?php echo $result['id'];?>">
