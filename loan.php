			    ...
			    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			        ...
			        $userid 		= mysqli_real_escape_string($db->link, $_POST['userid']);
			         ...
			         if ($name == "" || $inputdate == "" || $loaninput == "" || $receiptNo == "" || $loanoutput == "" || $vouchar == "") {
			         	...
			         	$cquery = "SELECT * FROM tbl_loan WHERE vouchar = '$vouchar'";
			            ...
			            $query = "INSERT INTO tbl_loan(name, inputdate, loaninput, receiptNo,  loanoutput, vouchar, remark, username) VALUES('$name', '$inputdate', '$loaninput', '$receiptNo', '$loanoutput', '$vouchar', '$remark', '$username')";
	...
	<div class="col-xs-12">
		...
		<div>
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
			<?php
				$query ="SELECT * FROM tbl_loan order by id desc";
					...
					<tr>
						...
						<td>
							<div class="">
								...
								<!-- Preview option -->
									<?php
										$selected="SELECT * FROM tbl_loan order by id";
								...
								<div class="modal-body">
								    ...
								    <p><h5><b>Loan Input : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $loaninput; ?>">

								    <p><h5><b>Receipt No : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $receiptNo; ?>">
								    
								    <p><h5><b>Loan Output : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $loanoutput; ?>">
								...
								||
								<!-- Edit option -->
								<a href="editloan.php?editId=<?php echo $result['id'];?>">
									<span class="glyphicon glyphicon-edit"></span>
								</a>
								<!-- Edit option -->
								||
								<a onclick="return confirm('Are you sure to Delete!');" class="red" href="deleteloan.php?delid=<?php echo $result['id'];?>">
