...
<div class="page-header">
    ...
    echo "<div class='alert alert-danger' role='alert' id='deletesuccess'>
	    ...
	    relation 		= '$relation',
	    nomini_birthdate = '$nomini_birthdate',
...
<?php
    $query = "select * from tbl_sbfprimaryshareinfo where id = '$id' order by id desc";
...
?>
			<form action="" method="POST" enctype="multipart/form-data" class="form-horizontal text-center">
				...
				<div class="form-group">
					<label class="col-xs-4 col-sm-5 control-label " for="form-field-1"> TIN Number :</label>
					<div class="col-xs-8 col-sm-7">
						<input type="text" class="col-xs-10 col-sm-5" name="tin_number" value="<?php echo $result['tin_number'];?>"/>
					</div>
				</div>

				<div class="form-group">
					<label class="col-xs-4 col-sm-5 control-label " for="form-field-1"> Applicant Date Of Birth :</label>
					<div class="col-xs-8 col-sm-7">
						<input type="text" class="date-picker col-xs-10 col-sm-5" id="form-field-date" type="text" value="<?php echo $result['birthdate'];?>" data-date-format="dd-mm-yyyy"  name="birthdate" readonly=""/>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-xs-4 col-sm-5 control-label " for="form-field-1">Nomini Date Of Birth :</label>
					<div class="col-xs-8 col-sm-7">
						<input type="text" class="date-picker col-xs-10 col-sm-5" id="form-field-date" type="text" value="<?php echo $result['nomini_birthdate'];?>" data-date-format="dd-mm-yyyy"  name="nomini_birthdate" readonly=""/>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-xs-4 col-sm-5 control-label " for="form-field-1">Share Holder Status :</label>
					<div class="col-xs-8 col-sm-7">
