...
<?php
    if (!isset($_GET['editId']) || $_GET['editId'] == NULL) {
        echo "<script>window.location = 'SellingCatagory.php';</script>";
    } else {
        $id = $_GET['editId'];
    }
?>
...
<?php
    $query = "select * from catatgory where id = '$id' order by id desc";
            ...
            <div class="tabbable">
                <div class="tab-content profile-edit-tab-content">
                    <div id="edit-basic" class="tab-pane in active">
                        <h4 class="header blue bolder smaller">Update Catagory</h4>
                        <div class="row">
