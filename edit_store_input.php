...
<?php
    if (!isset($_GET['editId']) || $_GET['editId'] == NULL) {
        echo "<script>windows.location = 'store_input.php';</script>";
    } else {
        $id = $_GET['editId'];
    }
?>
			    ...
			    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			        ...
			        echo "<div class='alert alert-danger alert-dismissible' id='deletesuccess' role='alert'>
			             ...
			             $query = "UPDATE tbl_storeInput
					        ...
					        if ($updated_row) {
					        	echo "<script>window.location ='store_input.php';</script>";
						        } else{
						            echo "<div class='alert alert-danger alert-dismissible' id='deletesuccess' role='alert'>
											<button type='button' class='close' data-dismiss='alert' aria-label='Close'>
												<span aria-hidden='true'><i class='ace-icon fa fa-times'></i></span>
...
<?php
    $query = "select * from tbl_storeInput where id = '$id' order by id desc";
			...
			<div class="tabbable">
				<div class="tab-content profile-edit-tab-content">
					<div id="edit-basic" class="tab-pane in active">
						<h4 class="header blue bolder smaller">Update Store Input Data</h4>
						<div class="row">
