...
<?php
    if (!isset($_GET['editId']) || $_GET['editId'] == NULL) {
        echo "<script>window.location = 'marketing_officer.php';</script>";
    } else {
        $id = $_GET['editId'];
    }
?>
...
<div id="user-profile-3" class="user-profile row">
    ...
    echo "<div class='alert alert-danger' role='alert' id='deletesuccess'>
        ...
        $query = "UPDATE tbl_marketing_officer
        SET
        name          = '$name',
        editDate      = '$editDate',
        username      = '$username'
...
<?php
    $query = "select * from tbl_marketing_officer where id = '$id' order by id desc";
            ...
            <div class="tabbable">
                <div class="tab-content profile-edit-tab-content">
                    <div id="edit-basic" class="tab-pane in active">
                        <h4 class="header blue bolder smaller">Update  Marketing Officer Name</h4>
                        <div class="row">
                            <div class="vspace-12-sm"></div>
                            <div class="col-xs-12 col-sm-8">

                                <div class="form-group">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-username">Marketing Officer Name :</label>
