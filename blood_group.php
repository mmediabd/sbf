...
<div class="page-header">
		...
		<h4 class="text-center">Add Blood Group</h4>
	</div><!-- /.page-header -->
	...
	<div class="row">
			    ...
			    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			        ...
			        $userid 		= mysqli_real_escape_string($db->link, $_POST['userid']);
			         ...
			         if ($name == "" || $username == "") {
			            ...
			            $query = "INSERT INTO tbl_bloodgroup(name, username) VALUES('$name', '$username')";
		...
		<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST"  class="form-horizontal text-center" role="form">
                <div class="form-group">
                    <label class="col-xs-4 col-sm-5 control-label"> Blood Group :</label>
	...
	<div class="col-xs-12">
		...
		<div>
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
			<?php
				$query ="SELECT * FROM tbl_bloodgroup order by id desc";
					...
					<tr>
						...
						<td>
							<div class="">
								...
								||
								<!-- Edit option -->
								<a href="editblood_group.php?editId=<?php echo $result['id'];?>">
									<span class="glyphicon glyphicon-edit"></span>
								</a>
								<!-- Edit option -->
								||
								<a onclick="return confirm('Are you sure to Delete!');" class="red" href="delblood_group.php?delid=<?php echo $result['id'];?>">
