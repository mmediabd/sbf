...
<div class="page-header">
		...
		<h4 class="text-center"><u>SBF To PTC Table</u></h4>
	</div><!-- /.page-header -->
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<?php
			    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			        ...
			        $takeamount 	= $fm->validation($_POST['takeamount']);
			        ...
			        $userid 		= mysqli_real_escape_string($db->link, $_POST['userid']);
			         ...
			         if ($inputdate == "" || $takeamount == "" || $vouchar == "") {
			         	...
			         	$cquery = "SELECT * FROM tbl_sbftoptc WHERE vouchar = '$vouchar'";
			            ...
			            $query = "INSERT INTO tbl_sbftoptc(inputdate, takeamount, vouchar, remark, username) VALUES('$inputdate', '$takeamount', '$vouchar', '$remark', '$username')";
		...
		<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="form-horizontal text-center" role="form">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-sm-7">
						<input type="text" placeholder="Enter Take Amount......" class="col-xs-10 col-sm-5" name="takeamount"/>
					</div>
				</div>
	...
	<div class="col-xs-12">
		...
		<div>
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
			<?php
				$query ="SELECT * FROM tbl_sbftoptc order by id desc";
				...
				if ($installment) {
					...
					<tr>
						...
						<td><?php echo "Tk. ".$result['takeamount'];?></td>
						...
						<td>
							<div class="">
								...
								<div class="modal-body">
								    ...
								    <p><h5><b>Take Amount : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $takeamount; ?>">
								...
								||
								<!-- Edit option -->
								<a href="editsbftoptc.php?editId=<?php echo $result['id'];?>">
									<span class="glyphicon glyphicon-edit"></span>
								</a>
								<!-- Edit option -->
								||
								<a onclick="return confirm('Are you sure to Delete!');" class="red" href="deletesbftoptc.php?delid=<?php echo $result['id'];?>">
