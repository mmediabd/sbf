...
<?php
    if (!isset($_GET['editId']) || $_GET['editId'] == NULL) {
        echo "<script>window.location = 'SisternconcernTosbf.php';</script>";
...
<div class="page-header">
    ...
    echo "<div class='alert alert-danger' role='alert' id='deletesuccess'>
        ...
        $query = "UPDATE tbl_sisterconcerntosbf
        SET
	    concern  		= '$concern',
	    inputdate		= '$inputdate',
	    editDate		= '$editDate',
...
<?php
    $query = "select * from tbl_sisterconcerntosbf where id = '$id' order by id desc";
...
?>
			<form action="" method="POST" class="form-horizontal text-center">
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-sm-7">
						<input type="text" class="col-xs-10 col-sm-5" name="take_amount" value="<?php echo $result['take_amount'];?>">
					</div>
				</div>
