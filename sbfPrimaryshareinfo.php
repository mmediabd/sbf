		...
		<div class="col-xs-12">
			...
			<?php
			    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			        ...
			        $tin_number 	  = mysqli_real_escape_string($db->link, $tin_number);
			        ...
			        $nomini_birthdate = mysqli_real_escape_string($db->link, $nomini_birthdate);
			        ...
			        $uploaded_image = "img/SBF_Share_Holder/".$unique_image;

			        if ($applicant_name == "" || $father_name == "" || $joining_date == "" || $acc_number == "" || $mobile_number == "" || $address == "" || $blood_group == "" || $NIDNumber == "" || $tin_number == "" || $birthdate == "" || $Nominisname == "" || $relation == "" || $nomini_birthdate == "" || $nomini_address == "" || $username == "") {
			        ...
			        $cquery = "SELECT * FROM tbl_sbfprimaryshareinfo WHERE acc_number = '$acc_number'";
			        ...
			        $query = "INSERT INTO tbl_sbfprimaryshareinfo(applicant_name, father_name, joining_date, acc_number, mobile_number, address, blood_group, image, NIDNumber, tin_number, birthdate, Nominisname, relation, nomini_birthdate, nomini_address, username) VALUES('$applicant_name', '$father_name', '$joining_date', '$acc_number', '$mobile_number', '$address', '$blood_group', '$uploaded_image', '$NIDNumber', '$tin_number', '$birthdate', '$Nominisname', '$relation', '$nomini_birthdate', '$nomini_address', '$username')";
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        ...
				        <h4 class="modal-title" id="myModalLabel">Add New Share Holder</h4>
				      </div>
				    ...
				    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" enctype="multipart/form-data">
				          ...
				          <div class="form-group">
				            ...
				            <input type="text" name="tin_number" placeholder="Enter TIN Number" class="form-control" id="tin_number">
				          </div>

				          <div class="form-group">
				            <label for="birthdate" class="control-label">Applicant Date Of Birth</label>
				            <input type="text" name="birthdate" class="form-control date-picker" id="form-field-date" value="<?php echo date('d-m-Y'); ?>" data-date-format="dd-mm-yyyy" readonly="" id="birthdate">
				          </div>
				          ...
				          <div class="form-group">
				            <label for="nomini_birthdate" class="control-label">Nomini Date Of Birth</label>
				            <input type="text" name="nomini_birthdate" class="form-control date-picker" id="form-field-date" value="<?php echo date('d-m-Y'); ?>" data-date-format="dd-mm-yyyy" readonly="" id="nomini_birthdate">
				          </div>
...
Primary Share Holder Details Information
</div>
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover">
	<thead>
		<tr>
			...
			<th class="hidden-xs hidden-sm">Joining Date</th>
	...
	<tbody>
<?php
	$query ="SELECT * FROM tbl_sbfprimaryshareinfo where status = '0' order by id desc limit 100";
	...
	if ($installment) {
		...
		<tr>
			...
			<td class="hidden-xs hidden-sm"><?php echo $result['joining_date'];?></td>
			...
			<td>
				<div class="">
					...
					<!-- Preview option -->
					<?php
						$selected="SELECT * FROM tbl_sbfprimaryshareinfo order by id";
						...
						if ($Person) {
							    ...
							    $nomini_birthdate =$result['nomini_birthdate'];
					...
					<div class="modal-body">
						<p><h5><b>Share Holder Picture : </b></h5></p>
					    ...
					    <p><h5><b>TIN Number : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $tin_number; ?>">

					    <p><h5><b>Applicant Date Of Birth : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $birthdate; ?>">
					    ...
					    <p><h5><b>Nomini Date Of Birth : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $nomini_birthdate; ?>">
					...
					||
						<!-- Edit option -->
					<a href="editSbfPrimaryshareinfo.php?editId=<?php echo $result['id'];?>">
						<span class="glyphicon glyphicon-edit"></span>
					</a>
						<!-- Edit option -->
					||
					<a onclick="return confirm('Are you sure to Delete!');" class="red" href="deletesbfPrimaryshareinfo.php?delid=<?php echo $result['id'];?>">
