...
<div class="page-header">
		...
		<h4 class="text-center"><u>Primary Share Input &amp; Output</u></h4>
	</div><!-- /.page-header -->
			...
			<?php
			    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			        ...
			        $userid 		= mysqli_real_escape_string($db->link, $_POST['userid']);
			         ...
			         if ($acc_number == "" || $name == "" || $inputdate == "" || $shareInput == "" || $receiptNo == "" || $shareOutput == "" || $voucharNo == "") {
			            ...
			            $query = "INSERT INTO tbl_primaryshareinputOutput(acc_number, name, inputdate, shareInput, receiptNo, shareOutput, voucharNo, remark, username) VALUES('$acc_number', '$name', '$inputdate', '$shareInput', '$receiptNo', '$shareOutput', '$voucharNo', '$remark', '$username')";
		...
		<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="form-horizontal text-center" role="form">
		   <div class="form-group tabbable">
			<label class="col-xs-4 col-sm-5 control-label " for="form-field-1">Account No :</label>
				...
				<div class="form-group">
					<label class="col-xs-4 col-sm-5 control-label"> Input Amount :</label>

					<div class="col-xs-8 col-sm-7">
						<input type="text" placeholder="Enter Input Amount......" class="col-xs-10 col-sm-5" name="shareInput"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-8 col-sm-7">
						<input type="text" placeholder="Enter Receipt No......" class="col-xs-10 col-sm-5" name="receiptNo"/>
					</div>
				</div>

				<div class="form-group">
					<label class="col-xs-4 col-sm-5 control-label""> Output Amount :</label>

					<div class="col-xs-8 col-sm-7">
						<input type="text" placeholder="Enter Output Amount......" class="col-xs-10 col-sm-5" name="shareOutput" />
					</div>
				</div>

				<div class="form-group">
					<label class="col-xs-4 col-sm-5 control-label""> Vaucher No :</label>

					<div class="col-xs-8 col-sm-7">
						<input type="text" placeholder="Enter Vaucher No......" class="col-xs-10 col-sm-5" name="voucharNo" />
					</div>
				</div>
		...
		<div class="col-xs-12">
			...
			<div>
				<table id="dynamic-table" class="table table-striped table-bordered table-hover">
					...
					<tbody>
				<?php
					$query ="SELECT * FROM tbl_primaryshareinputoutput order by id desc limit 100";
					...
					if ($installment) {
						...
						<tr>
							...
							<td class="hidden-xs"><?php echo "Tk. ".$result['shareInput'];?></td>
							<td class="hidden-xs"><?php echo "Tk. ".$result['shareOutput'];?></td>
							<td>
								<div class="">
									...
									<!-- Preview option -->
						<?php
							$selected="SELECT * FROM tbl_primaryshareinputoutput order by id";
							...
							if ($Person) {
								    ...
								    $shareInput		=$result['shareInput'];
								    $receiptNo		=$result['receiptNo'];
								    $shareOutput 	=$result['shareOutput'];
								    $voucharNo  	=$result['voucharNo'];
						...
						<div class="modal-body">
						    ...
						    <p><h5><b>Input Amount : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $shareInput; ?>">

						    <p><h5><b>Receipt No : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $receiptNo; ?>">
						    
						    <p><h5><b>Output Amount : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $shareOutput; ?>">

						    <p><h5><b>Vaucher No : </b></h5></p><input style="width: 100%" type="" class="form-control" readonly="" value="<?php echo $voucharNo; ?>">
						...
						||
						<!-- Edit option -->
						<a href="editshareinputoutput.php?editId=<?php echo $result['id'];?>">
							<span class="glyphicon glyphicon-edit"></span>
						</a>
						<!-- Edit option -->
						||
						<a onclick="return confirm('Are you sure to Delete!');" class="red" href="deleteprimaryshareinputOutput.php?delid=<?php echo $result['id'];?>">
