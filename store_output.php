	...
	<div class="page-header">
		...
		<?php
			    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			        ...
			        $query = "INSERT INTO tbl_storeoutput(prodcutName, brandName, companyName, agentName, inputDate, chalanNo, quantity, price, totalPrice, remarks, username) VALUES('$prodcutName', '$brandName', '$companyName', '$agentName', '$inputDate', '$chalanNo', '$quantity', '$price', '$totalPrice', '$remarks', '$username')";
			...
			<div class="tabbable">
				<div class="tab-content profile-edit-tab-content">
					<div id="edit-basic" class="tab-pane in active">
						<h4 class="header blue bolder smaller">Store Output Data</h4>
						<div class="row">
	...
	<div class="col-xs-12">
		...
		<div>
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
			<?php
				$query ="SELECT * FROM tbl_storeoutput order by id desc";
					...
					<tr>
						...
						<td>
							<div class="">
								...
								<!-- Preview option -->
								<?php
									$selected="SELECT * FROM tbl_storeoutput order by id";
								...
								||
								<!-- Edit option -->
								<a href="edit_store_output.php?editId=<?php echo $result['id'];?>">
									<span class="glyphicon glyphicon-edit"></span>
								</a>
								<!-- Edit option -->
								||
								<a onclick="return confirm('Are you sure to Delete!');" class="red" href="delete_store_output.php?delid=<?php echo $result['id'];?>">
